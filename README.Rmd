...
{ggprop.test} and friends, in contrast, are an attempt to capture the *statistical stories* that are told in *classrooms* all the time visually, but don't yet have translations to code.
