...
# Use the compute in a rendered plot (sketch mode - where you don't actually define functions, we just have proposals commented out.
...
Another approach that is less concerned with being a bridge to ggplot2 layer extension...?  Not sure if this would work well in the 2 prop context, for example, given group-wise compute relevance...
